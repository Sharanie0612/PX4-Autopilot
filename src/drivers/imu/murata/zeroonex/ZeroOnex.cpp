...
ZeroOnex::ZeroOnex(const I2CSPIDriverConfig &config) :
	SPI(config),
	I2CSPIDriver(config),
...
void ZeroOnex::ResetSpi6(bool reset)
{
...
void ZeroOnex::exit_and_cleanup()
{
	I2CSPIDriverBase::exit_and_cleanup();
}

void ZeroOnex::print_status()
{
...
void ZeroOnex::sensor_ctrl(uint8_t fifo_rst)
{
	uint32_t reg;
	uint8_t wbuf[8];
	uint8_t ptr = 0;
...
void ZeroOnex::fpga_read_config(void)
{
	uint8_t ptr = 0;
	/**< reset fifo */
...
void ZeroOnex::fpga_write_cmd(uint32_t addr, uint8_t ptr, uint8_t read_valid, uint8_t is_sensor, uint8_t offset)
{
	uint8_t buff[16];
...
bool ZeroOnex::collect_and_publish()
{
	bool success = read_data();
	return success;
}

bool ZeroOnex::read_data()
{
...
void ZeroOnex::configure_registers()
{
	uint32_t reg_value;
...
bool ZeroOnex::validate_sensor_status()
{
...
bool ZeroOnex::validate_register_configuration()
{
	uint32_t value;
	bool success = true;
...
uint16_t ZeroOnex::fpga_read_reg16(uint16_t reg)
{
	uint8_t wbuf[8];
	uint8_t ptr = 0;
...
uint8_t ZeroOnex::wait_direct_busy(void)
{
...
uint16_t ZeroOnex::_sch16t_read_status(uint16_t addr)
{
	uint32_t value;
...
void ZeroOnex::read_status_registers()
{
...
uint8_t ZeroOnex::register_read(uint16_t addr, uint32_t *value)
{
	uint8_t tbuf[8];
	uint8_t rbuf[8];
...
void ZeroOnex::register_write(uint16_t addr, uint32_t value)
{
...
uint64_t ZeroOnex::transfer_spi_frame(uint64_t frame)
{
	uint16_t buf[3];
...
uint8_t ZeroOnex::calculate_crc8(uint64_t frame)
{
...
void ZeroOnex::fpga_read_fifo8(uint16_t reg, uint8_t *value, uint8_t size)
{
	uint8_t wbuf[32];
	uint8_t ptr = 0;
	uint8_t i;
...
void ZeroOnex::fpga_write_reg8(uint16_t reg, uint8_t value)
{
	uint8_t wbuf[8];
	uint8_t ptr = 0;
...
uint8_t ZeroOnex::fpga_read_reg8(uint16_t reg)
{
	uint8_t wbuf[8];
	uint8_t ptr = 0;
...
void ZeroOnex::fpga_write_reg16(uint16_t reg, uint16_t value)
{
	uint8_t wbuf[8];
	uint8_t ptr = 0;
...
void ZeroOnex::fpga_write_ram8(uint16_t reg, uint16_t ram_addr, uint8_t *value, uint16_t size)
{
	uint8_t wbuf[32];
	uint8_t ptr = 0;
	uint8_t i;
...
void ZeroOnex::fpga_read_ram8(uint16_t reg, uint16_t ram_addr, uint8_t *value, uint16_t size)
{
	uint8_t wbuf[32];
	uint8_t ptr = 0;
	uint8_t i;
...
uint8_t ZeroOnex::fpga_test(void)
{
